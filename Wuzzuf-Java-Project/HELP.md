...
* The following dependencies are not known to work with Spring Native: 'Spring Session, Spring HATEOAS, Spring Boot
  DevTools, Rest Repositories HAL Explorer, Jersey, Spring Web Services, Rest Repositories, Spring Configuration
...
```
$ docker run --rm -p 8080:8080 Wuzzuf-Java-Project:0.0.1-SNAPSHOT
```
